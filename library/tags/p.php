...
$out_temp = <<< ___EOF___
 <p class='${html_tag_class}_item'><span class='${html_tag_class}_date'>$start_end_date_value</span> $output_category_temp <span title="$gc_description_title">$gc_title</span>

...
$out_temp = <<< ___EOF___
 <li class='${html_tag_class}_item'><p class='${html_tag_class}_date'>$start_date_value</p>$output_category_temp<a target="_blank" class='${html_tag_class}_link' href='$gc_link' title="$gc_description_br">$gc_title</a>
